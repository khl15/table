...
<head>
	<title>Data Pemilu MAZAWA</title>
</head>
...
<body>
	...
	<h2 style="text-align: center;">DATA PEMILU MANAJEMEN ZAKAT DAN WAKAF</h2>
	...
	<table border="1">
		...
		include 'koneksi.php';
		$no = 1;
		$data = mysqli_query($koneksi, "SELECT * FROM `mazawa` WHERE `pilih` = '1' OR `pilih` = '2'");
		$data2 = mysqli_query($koneksi, "SELECT * FROM `mazawa` WHERE `pilih` = 'null'");
